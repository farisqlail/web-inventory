...
@section('content')
                        ...
                        <form action="{{ url('/transaksibarangmasuk/filter') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4" align="left">
                                    <button class="btn btn-success" style="margin-top: 10px;" type="submit">Filter</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-auto mt-2">
                                        <a class="btn btn-danger btn-round ml-auto" href="/transaksibarangmasuk/export/{{$filter}}">
                                            ...
                                            @if (!empty($DaftarBarangMasuk))
                                                @foreach ($DaftarBarangMasuk as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#ModalHapusBarangMasuk{{ $item->ID_MASUK }}"
    ...
    @foreach ($DaftarBarangMasuk as $h)
        <div class="modal fade" id="ModalHapusBarangMasuk{{ $h->ID_MASUK }}" tabindex="-1" role="dialog"
