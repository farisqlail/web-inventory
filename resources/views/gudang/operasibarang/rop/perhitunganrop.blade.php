...
@section('content')
        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Proses Perhitungan Reorder Point</h4>
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item">
                            <a href="#">Perhitungan Reorder Point</a>
                        </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Tambah Data Reorder Point </div>
                            </div>
                            <div class="card-body">
                                {!! Form::open(['url' => '/TambahDataReorderPoint', 'method' => 'POST','enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tgl_rop" placeholder="Masukkan Tanggal Input Perhitungan" required>
                                </div>
    ...
    function cari_barang(val) {
        const url = "ajaxbisarop"; // get the url of the view
        console.log(val);
